...
import com.basasagerald.incrs.Lecturer.Answers;
import com.basasagerald.incrs.Lecturer.Questions_Lecturer;
...
import com.basasagerald.incrs.Recyclerview_Lect.Lecturer_Model;
import com.basasagerald.incrs.Recyclerview_Lect.Lecturer_PostAdapter;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (post.equals(0)){
                    Intent intent=new Intent(getActivity(), Questions_Lecturer.class);
