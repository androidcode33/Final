...
import com.basasagerald.incrs.Student.Feedback;
...
public class Student_PostAdapter extends RecyclerView.Adapter<Student_PostAdapter.MyViewHolder> {

    private List<Student_Model> postsList;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView  question, feedback;
    ...
    public Student_PostAdapter(List<Student_Model> postsList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_student, parent, false);
